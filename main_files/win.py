...
font1 = pygame.font.Font('images_fonts/PermanentMarker-Regular.ttf', 40)
...
text_splash = font1.render('You won and reached the promised land! Now you can rebuild your life.', False, 'white')
text_splash1 = font1.render('Part 2 coming out soon...', False, 'white')
counter=1
