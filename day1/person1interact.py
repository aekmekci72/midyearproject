...
text_splash = font1.render('ENTER TEXT HERE (Left for text 1, right for text 2)', False, 'white')
text_splash1 = font1.render('ENTER TEXT HERE', False, 'white')
text_splash2 = font1.render('ENTER TEXT HERE 2', False, 'white')
counter=1
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            counter+=1
            if counter==2:
                text_splash = font1.render("MORE TEXT", False, "white")
                text_splash1 = font1.render("MORE TEXT", False, "white")
            if counter==3:
                text_splash = font1.render("MORE TEXT", False, "white")
                text_splash1 = font1.render("MORE TEXT", False, "white")
            if counter==4:
    ...
    for event in pygame.event.get():
        if event.key==pygame.K_LEFT:
            ...
            screen.blit(text_splash2, (60,140))
