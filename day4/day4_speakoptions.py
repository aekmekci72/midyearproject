...
menu_items = [
    ("Mechanic", "conversations/mechanic.py"),
    ("Lady Margaret", "conversations/ladymargaret.py"),
]
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if position[0]>50 and position[0]<350:
                if position[1]>150 and position[1]<200:
                    os.system("python conversations/mechanic.py 1")
                    os.system("python day3/day3_part1.py 1")
                    pygame.quit() 
                elif position[1]>215 and position[1]<275:
                    os.system("python conversations/ladymargaret.py 1")
                    os.system("python day4/day4_part1.py 1")
                    pygame.quit()
    draw_menu()
